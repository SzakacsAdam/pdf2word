...
from src.main_pdf_converter.project_folders.folders_outputs.folders1 import ErrorDir
from src.main_pdf_converter.project_folders.folders_outputs.folders1 import BackUpPdf
from src.main_pdf_converter.project_folders.folders_outputs.folders1 import OutputDir
# from src.folder_handler.pdf_folders import PdfFolders
from src.main_pdf_converter.pdf_handler import PdfFile
from src.utils import RunThreaded


class PdfConverter(RunThreaded):
    daemon: bool = True
    ...
    def __init__(self, av_doc_id, pdf_folders, error_dir: ErrorDir,
    ...
    def __convert(self, pdf: PdfFile) -> bool:
        try:
            ...
            out_name: str = join(
                ...
                f"{pdf.file_name}.{pdf.pdf_convert_type.value}"
            )
